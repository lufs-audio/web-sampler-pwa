// Throwaway UI. Its ONLY job is to exercise every public SamplerEngine method
// so the wiring surface is proven end-to-end before Amacher builds the real UI.
// Not the deliverable — the engine is. See docs/AMACHER-BRIEF.md.
import { SamplerEngine, PAD_COUNT, type EngineState } from './engine/engine.ts';
